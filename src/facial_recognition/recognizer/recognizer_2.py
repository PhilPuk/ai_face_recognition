...
class Model():
    def __init__(self, modelNumber, use_micro_model):
        ...
        if use_micro_model:
            self.choosen_trainer = "C:/Users/Student/Documents/repos/ai_face_recognition/ai_face_recognition/micro_1_1.yml"     
...
def main():
    ...
    printWithTime("Programm started, packages loaded!")
    model = Model(0, True)
    printWithTime("Model data loaded!")

    Cam = Camera([640,480])
    printWithTime("Camera set up!")
