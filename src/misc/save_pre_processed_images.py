...
def PreProcessAndSaveImagesNewPerson(src_path, saving_path, id, cam_resolution=[640,480]):
    src_path = src_path + f"/{id}"
    new_resolution = [int(cam_resolution[0] * 0.4),int(cam_resolution[1] * 0.4)]
